...
config :jamie, JamieWeb.Endpoint,
  ...
  live_view: [signing_salt: "YxLMuFIl"]
...
config :jamie, Oban,
  ...
  queues: [default: 10, emails: 20, notifications: 10],
  repo: Jamie.Repo,
  plugins: [
    {Oban.Plugins.Pruner, max_age: 60 * 60 * 24 * 7}
    # Cron jobs will be enabled in Phase 6 after workers are created
    # {Oban.Plugins.Cron,
    #  crontab: [
    #    {"0 8 * * *", Jamie.Workers.CleanupJob},
    #    {"0 */1 * * *", Jamie.Workers.ReminderJob}
    #  ]}
  ]
